...
from scraper.list_parser import parse_list_page, list_page_urls

# Filter groups we care about for the web app
GOOD_FOR_FILTERS = {
    "solo-dining",
    "groups",
    "family-friendly",
...
# Michelin filter value -> app slug
...
def collect_filter_metadata(
    ...
    *,
    ...
    """
    Returns per-restaurant metadata from Michelin list-page filters:
    good_for, special_diets, services, open_days, serves_lunch, serves_dinner, online_booking
    """
